...
const Footer = () => {
  return (
    <footer className='bg-zinc-200 py-20'>
      <div className='flex flex-wrap gap-y-12 mx-w-[1400px] mx-auto px-20'>
        ...
        <ul className='flex-1'>
          <li>
            <h5 className='text-zinc-800 tet-2xl font-bold'>Company</h5>
          </li>
          <li className='mt-6'>
        ...
        <ul className='flex-1'>
          <li>
            <h5 className='text-zinc-800 tet-2xl font-bold'>Support</h5>
          </li>
        ...
        <div className='flex-1x'>
          ...
          <p className='mt-6 text-inc-600'>
            Questions or Feedback?<br />
            We'd love to hear from you.
          </p>

          <div className='flex bg-white p-1 rounded-lg mt-6 '>
            <input type="email" name="email" id="email" autoComplete='off' placeholder='Email Address' className='h-[5vh] pl-4 flex-1 focus:outline-none px-2'/>
            <button className='bg-gradient-to-b from-orange-400 to-orange-500 p-2 rounded-lg  text-2xl text-white hover:to-orange-600 cursor-pointer'>
              <IoIosArrowForward />
            </button>
          </div>
        </div>
